                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full md:w-1/2 lg:1/2 px-5 self-center">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="#/" className="w-12 h-12 border border-slate-300 rounded-full mr-3 flex justify-center items-center hover:border-primary hover:bg-primary hover:text-white">
                                <svg role="img" width="30" className="hover:fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
